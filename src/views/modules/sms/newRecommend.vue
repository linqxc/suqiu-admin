        ...
        <el-table-column label="是否推荐" width="200" align="center">
          <template slot-scope="scope">
            <el-switch
              ...
              :active-value="1"
              :inactive-value="0"
              v-model="scope.row.newRecommendStatus"
            ></el-switch>
          </template>
        </el-table-column>
        <el-table-column label="排序" width="160" align="center">
          <template slot-scope="scope">{{scope.row.newSort}}</template>
        </el-table-column>
        <el-table-column label="状态" width="160" align="center">
          <template slot-scope="scope">{{scope.row.newRecommendStatus | formatRecommendStatus}}</template>
        </el-table-column>
...
export default {
  ...
  methods: {
    ...
    handleRecommendStatusStatusChange(index, row) {
      this.updateRecommendStatusStatus(row.productId, row.newRecommendStatus);
    },
    ...
    handleSelectDialogConfirm() {
      ...
      this.$confirm("使用要进行添加操作?", "提示", {
        ...
        // });
        this.$http({
          url: this.$http.adornUrl("/smsPeopleRecommend/createNew"),
          method: "post",
      ...
      this.$confirm("是否要修改排序?", "提示", {
        ...
        this.$http({
          url: this.$http.adornUrl(
            "/smsPeopleRecommend/sortNew/" + this.sortDialogData.id
          ),
          method: "post",
    ...
    getList() {
      ...
      // })
      this.$http({
        url: this.$http.adornUrl("/smsPeopleRecommend/listNew"),
        method: "post",
    ...
    deleteProduct(ids) {
      this.$confirm("是否要删除该推荐?", "提示", {
        ...
        // });
        this.$http({
          url: this.$http.adornUrl("/smsPeopleRecommend/deleteNew"),
          method: "post",
          params: params
        }).then(({ data }) => {
          if (data.status === 1) {
